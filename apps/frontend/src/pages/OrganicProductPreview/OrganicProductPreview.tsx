...
const OrganicProductPreview: React.FC = () => {
  ...
  const getAllCopies = async () => {
    ...
    try {
      ...
      const result = await axios.get(
        `/api/organic/copy/all-copies/${product}?minLift=${minLift}&maxLift=${maxLift}`
      );
      ...
      <InputGroup>
        <InputContainer>
          <FloatingLabelInput
            ...
            placeholder="Product Name (ex: OAYPI)"
          />
        </InputContainer>
        <InputContainer>
          <FloatingLabelInput
...
export default OrganicProductPreview;
