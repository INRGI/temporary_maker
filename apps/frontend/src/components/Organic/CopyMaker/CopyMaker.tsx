...
import { CopyStyles, Preset } from "../../../types/organic";
...
import { ResponseCopy } from "../../../types/organic/copy-response";
...
const CopyMaker: React.FC<Props> = ({ preset }) => {
  ...
  const STORAGE_KEY = "organic-last-copies";
  ...
  const makeCopies = async () => {
    try {
      ...
      const response = await axios.post(
        `/api/organic/copy/make-multiple-copies`,
        {
          preset,
  ...
  const FORMAT_STORAGE_KEY = "organic-format-preferences";
